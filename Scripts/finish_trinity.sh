...
nmcli con add type bridge autoconnect yes con-name brkvm ifname brkvm ip4 10.10.10.12/24 gw4 10.10.10.1
nmcli con modify brkvm ipv4.address 10.10.10.12/24 ipv4.method manual
