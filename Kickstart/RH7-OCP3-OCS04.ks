...
# Network information
network --bootproto=static --device=eth0 --ip=10.10.10.194 --netmask=255.255.255.0 --gateway=10.10.10.1 --activate --nameserver=10.10.10.121,10.10.10.122,8.8.8.8 --hostname=rh7-ocp3-ocs04.matrix.lab 
