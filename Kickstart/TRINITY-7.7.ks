...
# Network information
network  --bootproto=static --device=eno1 --onboot=on --ipv6=auto --activate --ip=10.10.10.12 --netmask=255.255.255.0 --gateway=10.10.10.1 --nameserver=10.10.10.121,10.10.10.122,8.8.8.8                     
...
part raid.0011 --size 200 --asprimary --grow --ondrive=vda
part raid.0021 --size 200 --asprimary --grow --ondrive=vdb
