...
# Network information
network  --bootproto=static --device=eno1 --onboot=on --ipv6=auto --activate --ip=10.10.10.11 --netmask=255.255.255.0 --gateway=10.10.10.1 --nameserver=10.10.10.121,10.10.10.122,8.8.8.8                     
