...
# Network information
network --bootproto=static --device=bond0 --ip=10.10.10.12 --netmask=255.255.255.0 --gateway=10.10.10.1 --noipv6 --bondopts=miimon=100,mode=802.3ad,lacp_rate=1  --bondslaves=eno1,eno2 --hostname=trinity.matrix.lab
network --bootproto=static --device=bond1 --ip=169.254.0.12 --bondopts=miimon=100,mode=802.3ad,lacp_rate=1  --bondslaves=ens3f0,ens3f1
network --bootproto=static --device=bond2 --ip=172.16.10.12 --netmask=255.255.255.0 --noipv6 --bondopts=miimon=100,mode=802.3ad,lacp_rate=1  --bondslaves=ens3f2,ens3f3
...
timezone America/Chicago --isUtc --ntpservers=neo.matrix.lab,trinity.matrix.lab,mansible.matrix.lab
# Users 
...
%pre --log=/tmp/ks_pre_diskman.log
#!/bin/sh
for DEV in b c d
do
if [ -b /dev/sd${DEV} ]
